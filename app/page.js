  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
      ...
      <div className="grid sm:grid-cols-2 divide-y sm:divide-y-0 sm:divide-x divide-gray-100">
        <button onClick={() => onChoose('quiz')} className="p-8 text-left hover:bg-gray-50 transition group">
          ...
          <h3 className="font-extrabold text-gray-900 text-lg mb-2">Take the Quiz</h3>
        ...
        <button onClick={() => onChoose('manual')} className="p-8 text-left hover:bg-gray-50 transition group">
          <div className="w-10 h-10 rounded-xl bg-gray-900 flex items-center justify-center mb-4">
            <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"/>
            </svg>
          </div>
          <h3 className="font-extrabold text-gray-900 text-lg mb-2">Customize Yourself</h3>
                      ...
                      {quizDone ? (
                        <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 text-center">
                          ...
                          <button onClick={() => { setQuizDone(false); setQuizFormula(null); }}
                            className="text-sm text-slate-500 underline hover:text-slate-800 transition">
                            Retake the quiz
                          </button>
                        </div>
                      ) : (
