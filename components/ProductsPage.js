...
export default function ProductsPage({ onGoToQuiz, quizFormula }) {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto">
      ...
      <div id="product-gel" className="grid md:grid-cols-2 gap-6 items-start mb-8">

        {/* ── Gel card — all sliders, quiz-aware ── */}
        <GelCard quizFormula={quizFormula} startOpen={false} onGoToQuiz={onGoToQuiz} />

        {/* ── Reusable Packet card ── */}
        <div id="product-packet" className="relative bg-white border border-gray-200 rounded-2xl overflow-hidden flex flex-col shadow-xl">
