  ...
  return (
    <div className="bg-white p-5 sm:p-8 rounded-2xl shadow-sm border border-gray-100">
      ...
      <div className="space-y-3 mb-6">
        {questions[step].options.map(option => (
          <button
            ...
            className={`w-full border py-3.5 sm:py-4 px-4 sm:px-6 rounded-xl font-medium transition text-left
              ${selected === option
      ...
      <button
        onClick={handleNext}
        disabled={!selected}
        className={`w-full py-4 rounded-xl font-bold transition text-base
          ${selected
